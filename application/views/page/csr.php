<div class="container-fluid">
	<div class="row">
		<div class="exit">
			...
			<h1 class="judul-page">CSR</h1>
	</div>
</div>
<div class="container-fluid skin-page-csr">
<?php 
	foreach ($tmp_csr as $data) {
 ?>
	<div class="col-sm-6 col-md-6 list-layanan">
		<div class="media">
			...
			<div class="media-body">
				...
				<a href="<?php echo site_url('sims/page/detail_csr'); ?>/<?php echo $data->id_artikel ?>">View Detail</a>
			</div>
		</div>
	</div>
<?php } ?>
