<div class="container-fluid">
	<div class="row">
			...
			<h1 class="judul-page">Layanan</h1>
	</div>
</div>
<div class="container-fluid skin-page-layanan">
<div class="row">
<?php 
	foreach ($tmp_layanan as $data) {
 ?>
	<div class="col-sm-6 col-md-6 list-layanan">
		<div class="media">
			...
			<div class="media-body">
				...
				<a href="<?php echo site_url('sims/page/detail_layanan'); ?>/<?php echo $data->id_artikel ?>">View Detail</a>
			</div>
		</div>
	</div>
<?php } ?>
